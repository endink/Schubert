...
namespace Microsoft.Net.Http.Client
{
    ...
    {
        private static readonly byte[] _endContentBytes = Encoding.ASCII.GetBytes("0\r\n\r\n");
        ...
        {
            return _innerStream.WriteAsync(_endContentBytes, 0, _endContentBytes.Length, cancellationToken);
        }
    }
}