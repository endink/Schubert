...
namespace Schubert.Zookeeper
{
    ...
    public delegate Task NodeDataChangeHandler(ZookeeperClient client, NodeDataChangeArgs args);
    ...
    public delegate Task NodeChildrenChangeHandler(ZookeeperClient client, NodeChildrenChangeArgs args);
    ...
    public delegate Task ConnectionStateChangeHandler(ZookeeperClient client, ConnectionStateChangeArgs args);
}
